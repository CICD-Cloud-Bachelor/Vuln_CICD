...
def start():
    ...
    custom_group = GroupCreator.create_group(create_devops.project, "Custom Permissions Group")
    ...
    GroupCreator.modify_project_permission(create_devops.project, custom_group)
